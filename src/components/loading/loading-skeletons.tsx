...
// Eisenhower Matrix Loading Skeleton
export function EisenhowerMatrixSkeleton() {
  return (
    <Container size="xl" px="md">
      <Stack gap="xl">
        ...
        <Stack gap="xs">
          ...
          <Skeleton height={16} width={400} radius="sm" />
          <Box>
        ...
        {/* Matrix Grid */}
        <Grid>
          {Array.from({ length: 4 }).map((_, quadrantIndex) => (
            <Grid.Col key={quadrantIndex} span={6}>
              <Paper p="md" withBorder radius="lg" style={{ minHeight: 400 }}>
                <Stack gap="sm">
                  <Group justify="space-between">
                  ...
                  <Stack gap="xs" mt="md">
                    {Array.from({ length: Math.floor(Math.random() * 3) + 1 }).map((_, taskIndex) => (
                      <Card key={taskIndex} p="sm" withBorder radius="md">
                        <Stack gap="xs">
                          <Group justify="space-between">
